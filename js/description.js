...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        arabic: {
            ...
            steps: [
                "\u200F1_ تصدر الملفات من جهازك مع رقم الترخيص و تمر عبر شركة السياحة الكفيلة",
                "\u200F2_ تصدر الملفات من شركة السياحة مع رقم الترخيص وترسل الى وزارة السياحة في هايتي",
                "\u200F3_ تصدر الملفات التي قمت بتقديمها من وزارة السياحة مع الاكواد المخصصة ثم الى وجهتها الاخيرة"
            ],
    ...
    if (selectedLanguage === 'arabic') {
        document.querySelector('.steps-text').setAttribute('dir', 'rtl');
    }
